...
exports.getMeeK1ModuleStubSignature = exports.toMeeK1Module = void 0;
...
const toMeeK1Module = (parameters) => {
    ...
    const walletClient7739 = parameters.walletClient.extend((0, experimental_1.erc7739Actions)());
    ...
    const signTypedDataErc7739 = async (typedData, verifierDomain) => {
        ...
        (0, viem_1.validateTypedData)({ domain, types, primaryType, message });
...
exports.toMeeK1Module = toMeeK1Module;
const getMeeK1ModuleStubSignature = (signatureType, superTxEntriesCount) => {
    ...
    if (signatureType === "safe-sa") {
        ...
        mockModePayload = (0, viem_1.concatHex)([
            ...
            "0x095ea7b3000000000000000000000000a0cb889707d426a7a386870a03bc70d1",
