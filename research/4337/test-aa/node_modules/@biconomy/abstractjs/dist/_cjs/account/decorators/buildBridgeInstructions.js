...
const buildBridgeInstructions = async (params) => {
    const { depositor, recipient, amount: targetAmount, toChainId, unifiedBalance, bridgingPlugins = [(0, toAcrossPlugin_1.toAcrossPlugin)()], feeData, mode = "DEBIT", metadata, lowerBoundTimestamp, upperBoundTimestamp, executionSimulationRetryDelay, simulationOverrides } = params;
    const tokenMapping = {
