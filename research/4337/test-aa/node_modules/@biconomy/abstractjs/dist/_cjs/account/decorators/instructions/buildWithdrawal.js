...
const buildWithdrawal = async (baseParams, parameters, composabilityParams) => {
    ...
    const { chainId, tokenAddress, amount, gasLimit, recipient = accountAddress, metadata: metadataOverride, lowerBoundTimestamp, upperBoundTimestamp, executionSimulationRetryDelay, simulationOverrides } = parameters;
