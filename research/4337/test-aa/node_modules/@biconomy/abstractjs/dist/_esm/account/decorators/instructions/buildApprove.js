...
export const buildApprove = async (baseParams, parameters, composabilityParams) => {
    ...
    const { chainId, tokenAddress, amount, gasLimit, spender, metadata, lowerBoundTimestamp, upperBoundTimestamp, executionSimulationRetryDelay, simulationOverrides } = parameters;
