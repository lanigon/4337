 ...
 * ```
 */
export declare function getMeeVersionsForQuoteRequest(account: MultichainSmartAccount, instructions: Instruction[], sponsorship: boolean, feeToken?: FeeTokenInfo): MeeVersionsWithChainId;
