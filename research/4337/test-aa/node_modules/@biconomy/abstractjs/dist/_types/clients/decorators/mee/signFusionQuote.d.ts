...
import { type SignSafeQuoteParams, type SignSafeQuotePayload } from "./signSafeQuote";
/**
 * Union type for parameters that can be used with signFusionQuote
 */
export type SignFusionQuoteParameters = SignPermitQuoteParams | SignOnChainQuoteParams | SignMmDtkQuoteParams | SignSafeQuoteParams;
/**
 * Union type for the payload returned by signFusionQuote
 */
export type SignFusionQuotePayload = (SignOnChainQuotePayload | SignPermitQuotePayload | SignSafeQuotePayload) & {
