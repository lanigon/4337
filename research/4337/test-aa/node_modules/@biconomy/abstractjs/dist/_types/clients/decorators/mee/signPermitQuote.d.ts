...
export declare const isLegacyEIP712Domain: (name: string, version: string, verifyingContract: Address, salt: Hex, domainSeparator: Hex) => boolean;
export declare const isDefaultEIP712Domain: (name: string, version: string, chainId: number, verifyingContract: Address, domainSeparator: Hex) => boolean;
export declare const isDefaultEIP712DomainWithSalt: (name: string, version: string, chainId: number, verifyingContract: Address, salt: Hex, domainSeparator: Hex) => boolean;
export declare const getEIP712DomainType: (name: string, version: string, chainId: number, verifyingContract: Address, salt: Hex, domainSeparator: Hex) => "legacy" | "default" | "default-with-salt" | "invalid";
/**
 ...
 * ```
 */
export declare const formatSignedPermitQuotePayload: (meeVersions: MeeVersionsWithChainId, quoteParams: GetPermitQuotePayload, metadata: PermitMetadata, signature: Hex) => SignPermitQuotePayload;
/**
 ...
 * ```
 */
export declare const signPermitQuote: (parameters: SignPermitQuoteParams) => Promise<OneOf<{
