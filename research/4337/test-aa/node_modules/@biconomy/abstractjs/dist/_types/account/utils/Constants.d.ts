...
export declare const SIG_TYPE_NO_STX_VANILLA_1271_EOA: Hex;
export declare const SIG_TYPE_NO_STX_VANILLA_1271_P256: Hex;
export declare const SIG_TYPE_NO_STX_P256: Hex;
export declare const SIG_TYPE_SIMPLE_P256: Hex;
...
export declare const NEXUS_DOMAIN_NAME = "Nexus";
export declare const NEXUS_DOMAIN_VERSION = "1.2.0";
export declare const NEXUS_DOMAIN_TYPEHASH = "EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)";
