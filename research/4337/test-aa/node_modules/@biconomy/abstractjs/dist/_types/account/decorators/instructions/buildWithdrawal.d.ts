...
import type { Instruction, InstructionLevelTimeBounds, Overrides } from "../../../clients/decorators/mee";
 ...
 * ```
 */
export declare const buildWithdrawal: (baseParams: BaseInstructionsParams, parameters: BuildWithdrawalParameters, composabilityParams?: ComposabilityParams) => Promise<Instruction[]>;
